"""
Django settings for stolen_dance_38231 project.
...
ROOT_URLCONF = 'stolen_dance_38231.urls'
...
WSGI_APPLICATION = 'stolen_dance_38231.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stolen_dance_38231 API",
    "DESCRIPTION": "API documentation for stolen_dance_38231 App",
    "VERSION": "v1",
}
